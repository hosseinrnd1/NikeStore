...
package com.myapp.nikestore.view.scroll;
 ...
 */
public class ObservableScrollView extends NestedScrollView implements com.myapp.nikestore.view.scroll.Scrollable {
    ...
    private com.myapp.nikestore.view.scroll.ObservableScrollViewCallbacks mCallbacks;
    private List<com.myapp.nikestore.view.scroll.ObservableScrollViewCallbacks> mCallbackCollection;
    ...
    @Override
    public void setScrollViewCallbacks(com.myapp.nikestore.view.scroll.ObservableScrollViewCallbacks listener) {
        mCallbacks = listener;
    }

    @Override
    public void addScrollViewCallbacks(com.myapp.nikestore.view.scroll.ObservableScrollViewCallbacks listener) {
    ...
    @Override
    public void removeScrollViewCallbacks(com.myapp.nikestore.view.scroll.ObservableScrollViewCallbacks listener) {
        if (mCallbackCollection != null) {
    ...
    private void dispatchOnDownMotionEvent() {
        ...
        if (mCallbackCollection != null) {
            for (int i = 0; i < mCallbackCollection.size(); i++) {
                com.myapp.nikestore.view.scroll.ObservableScrollViewCallbacks callbacks = mCallbackCollection.get(i);
